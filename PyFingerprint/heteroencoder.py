"""
Features - Main Heteroencoder Module
==============================

Clone from https://github.com/pcko1/Deep-Drug-Coder.git
License: MIT
Author: Pan Kotsias
...
class DescriptorGenerator(SmilesGenerator):
    ...
    def __init__(self, x, y, smilesvectorizer, smilesvectorizer_2,
                 batch_size=32, shuffle=False, seed=None,
                 dtype=np.float32):
        super(DescriptorGenerator,self).__init__(x, y, smilesvectorizer,
                 batch_size=batch_size, shuffle=shuffle, seed=seed,
                 dtype=dtype)
        self.smilesvectorizer = smilesvectorizer
        self.smilesvectorizer_2 = smilesvectorizer_2
